...
"""
Parzen density estimator with an isotropic Gaussian kernel

work for data of arbitrary dimension d
train() learns the parameters 
predict() computes the log density
"""
